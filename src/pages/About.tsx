                ...
                <div className="content">
                    <div className="p-content">
                        <div className="bio">
                            ...
                            <p>Currently, I'm working with a team on another project. The project is a school website with a Student Database Management System. I'm working with UI/UX Designers, Backend and Frontend developers. You can follow me on <a href='https://twitter.com/Reactjs_babe' target='_blank'>Twitter</a> or check out the <a href='https://github.com/balotofi/toweringheights-frontend' target='_blank'>Github repo</a> to follow up on the project.</p>
